...
music.onloadeddata = function () {
    ...
    var dh = parseInt(music.duration / 3600)
    duration.innerHTML = dh + ':' + dm + ':' + ds
}
...
music.addEventListener('timeupdate', function () {
    ...
    var hm = parseInt(music.duration / 3600)
    currentTime.innerHTML = hm + ':' + cm + ':' + cs
}, false)
...
document.getElementById("calculate").addEventListener("click", hmsToSecondsOnly, false);